...
import { GLOBAL_NEWS_SLUG_AND_TAG, GLOBAL_NEWS_TAGS_SLUG_AND_TAG } from '@/lib/constants'
      ...
      fields: [
        {
          ...
          fields: [
            ...
            },
            {
              ...
              admin: {
                width: '50%',
                description: 'Unique key like rope, export, quality-control.',
              },
            },
          ],
        },
  ...
  hooks: {
    afterChange: [
      async () => {
        ...
        // Also revalidate News because news cards may display tag labels.
