...
// /** ⭐ NEW: block → array[] → blocks[] → groupKey{} → nestedArrayKey[] → media */
...
//   blockNestedDeepFields?: BlockNestedDeepMediaConfig[]
//   blockArrayBlocksFields?: BlockArrayBlocksMediaConfig[]
//   blockArrayBlocksGroupFields?: BlockArrayBlocksGroupMediaConfig[] // ⭐ NEW
// }) {
//   const {
//     req,
//     doc,
...
//     blockNestedDeepFields = [],
//     blockArrayBlocksFields = [],
//     blockArrayBlocksGroupFields = [], // ⭐ NEW
//     skipOnDraft = true,
//     onAfterChange,
//     singleDocSlug,
//     collectionSlug,
...
//         // handle array → blocks → array removals
//         await cleanupArrayBlocks({
//           req,
//           previousDoc,
//           doc,
...
//         // ⭐ handle array → blocks → group → array removals
