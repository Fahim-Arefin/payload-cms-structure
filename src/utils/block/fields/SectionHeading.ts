...
type Args = {
  ...
  // ✅ new optional fields, default false so no old schema breaks
  includeDownloadButton?: boolean
  downloadButtonLabelMax?: number
}
      ...
      fields: [
        {
          ...
          required: false,
          defaultValue: 'Download Case Study',
          maxLength: downloadButtonLabelMax,
          validate: validateShortText('Download Button Label', downloadButtonLabelMax, false),
          admin: {
            description: `Example: Download Case Study. Max ${downloadButtonLabelMax} characters.`,
          },
        },
        {
          name: 'file',
          ...
          required: false,
          admin: {
            description: 'Upload the downloadable PDF file here.',
          },
        },
      ],
    })
