  ...
  return (
    <div className="font-avenir bg-white">
      <HeroSection
        ...
        position="[object-position:30%_50px] md:[object-position:50%_10%] lg:[object-position:50%_0%] xl:[object-position:50%_18%] 2xl:[object-position:50%_16%]"
      />
