...
function page() {
  ...
  const planInfoData = {
    image:
      '/assets/solutions/individual/health-and-protection/accidental-coverage/web/planInfo4.png',
    mobileImage:
  ...
  const offersData = [
    {
      image: '/assets//icons/web/offer5.png',
      mobileImage: '/assets//icons/mobile/offer5.png',
      bgImage:
        '/assets/solutions/individual/health-and-protection/accidental-coverage/web/offerbg5.jpg',
      bgMobileImage:
    ...
    {
      image: '/assets//icons/web/offer6.png',
      mobileImage: '/assets//icons/mobile/offer6.png',
      bgImage:
        '/assets/solutions/individual/health-and-protection/accidental-coverage/web/offerbg6.jpg',
      bgMobileImage:
    ...
    {
      image: '/assets//icons/web/offer7.png',
      mobileImage: '/assets//icons/mobile/offer7.png',
      bgImage:
        '/assets/solutions/individual/health-and-protection/accidental-coverage/web/offerbg7.jpg',
      bgMobileImage:
    ...
    {
      image: '/assets//icons/web/offer8.png',
      mobileImage: '/assets//icons/mobile/offer8.png',
      bgImage:
        '/assets/solutions/individual/health-and-protection/accidental-coverage/web/offerbg8.jpg',
      bgMobileImage:
