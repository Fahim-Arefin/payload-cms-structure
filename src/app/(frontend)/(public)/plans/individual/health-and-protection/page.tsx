...
function PlanPage() {
  ...
  const indivisualPlantData = [
    ...
    },
    {
      title: 'Shanta',
      titleBN: 'শান্তা',
      biggerTitle: 'Spouse Shield',
      biggerTitleBN: 'স্পাউস শিল্ড',
      description: 'Amplyfying your protection- enhancing the shared journey.',
      descriptionBN: `একসাথে চলার পথে নির্ভরতার প্রতিটি পদক্ষেপ`,
      link: '/plans/individual/health-and-protection/spouse-shield',
