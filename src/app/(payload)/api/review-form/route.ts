...
// v1 logo support only outlook mailbox
// import config from '@payload-config'
// import { getPayload } from 'payload'
// import { NextResponse } from 'next/server'
// import { sendEmailViaMsGraph } from '@/lib/email/msGraphMailer'
...
//   const baseUrl = 'https://staging.sagar-rope.com/'
...
//     const subject = `New Customer Review — ${cleanName}`

//     const logoUrl = getPublicAssetUrl('/assets/images/logo.png')

//     const text = [
//       'New customer review submitted from Sagar Rope website.',
//       '',
//       `Buyer Name: ${cleanName}`,
//       `Email: ${cleanEmail}`,
...
//                       New Customer Review
//                     </h1>
//                     <p style="margin:8px 0 0;font-size:14px;line-height:1.5;color:#4b4b63;">
//                       Submitted from Sagar Rope website feedback form
//                     </p>
//                   </td>
...
//                       alt="Sagar Rope Logo"
//                       style="display:inline-block;max-width:130px;height:auto;border:0;outline:none;text-decoration:none;"
//                     />
//                   </td>
//                 </tr>
//               </table>
...
//             <table style="width:100%;border-collapse:collapse;font-size:15px;color:#070725;">
//               <tr>
//                 <td style="padding:10px 0;width:180px;font-weight:700;vertical-align:top;">Buyer Name</td>
...
//             <div style="margin-top:22px;padding-top:20px;border-top:1px solid #e2e8f0;">
//               <h2 style="margin:0 0 10px;font-size:18px;line-height:1.4;color:#070725;">
//                 Review
//               </h2>
...
const getLogoBase64 = async () => {
  try {
    ...
    console.error('[review-form] Failed to read inline logo:', error)
    return undefined
  }
}
        ...
        >
          ...
          <tr>
            <td
              ...
              "
            >
              ${escapeHtml(cleanReview).replace(/\n/g, '<br />')}
            </td>
          </tr>
        </table>
