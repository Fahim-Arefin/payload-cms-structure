...
import SearchBarSection2 from './SearchbarSection2'
...
async function InnerSearchbar({ bgColor }: Props) {
  const suggestions = await fetchSearchSuggestions()

  return <SearchBarSection2 suggestions={suggestions} backgroundColor={bgColor} />
}
