...
//         gap-4 lg:gap-6 xl:gap-8 2xl:gap-28
//         grid grid-cols-1 md:grid-cols-12 "
//     >
//       {/* left */}
//       <div
//         className="col-span-1 md:col-span-4 border border-black
//           flex flex-col items-center justify-center
//           transition-all duration-300 ease-out
//           "
//       >
//         <div className="relative w-fit h-fit aspect-[800/1008] border border-black">
//           <Image
//             src={Frame}
//             alt="Frame"
//             quality={90}
...
//         transition-all duration-300 ease-out
//           space-y-6 border border-black
//           "
//       >
//         {/* icon */}
//         <div
//           className="
//             xl:w-[70px] 2xl:w-[80px]
//             xl:h-[67px] 2xl:h-[77px]"
//         >
//           <Image
//             src={QuoteIcon}
//             alt="Quote Icon"
...
//         {/* description */}
//         <div
//           className={`font-manrope text-[16px] md:text-[16px] lg:text-[18px] xl:text-[22px] 2xl:text-[24px] tracking-[1.1px] leading-[181.818%]
//             text-dark-3 text-justify transition-all duration-300 ease-out
//             ${expand ? 'line-clamp-none' : 'line-clamp-6'}
//             `}
//         >
