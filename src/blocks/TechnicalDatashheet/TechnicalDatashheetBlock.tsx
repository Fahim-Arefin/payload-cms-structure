...
//         <div
//           className="flex flex-col justify-center items-center md:flex-row md:justify-between md:items-center bg-white-1 mt-4 lg:mt-6 xl:mt-8 2xl:mt-10
//         p-4 gap-2 md:gap-0
//         md:px-12 lg:px-20 xl:px-24 2xl:px-28
//         md:py-6 lg:py-10 xl:py-12 2xl:py-14"
//         >
//           <div className="font-proxima global-h4 font-bold text-dark-1">{block?.title}</div>
//           <div>
//             {fileUrl ? (
//               <Button
//                 asChild
