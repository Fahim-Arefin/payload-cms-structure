...
// ✅ New hex color validator (per your spec)
  ...
  fields: [
    /* ---------------------- FAQ TAB ---------------------- */
    {
      ...
      fields: [
        ...
        // Exactly 6 FAQ categories from fixed options (unique keys)
        {
          name: 'categories',
          type: 'array',
          ...
          fields: [
            {
              ...
              admin: { width: '50%', description: 'Used for all rows. No links/IDs stored here.' },
            },
            {
              name: 'buttonTextBN',
              type: 'text',
