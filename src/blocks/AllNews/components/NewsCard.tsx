...
//       group-hover/news-card:border-primary-1
//       group-hover/news-card:bg-primary-1
//       group-hover/news-card:text-white-1
//     "
//               >
//                 {tag.label}
//               </span>
  ...
  return (
    ...
    "
      ...
      >
        <Link
          href={newsHref}
          aria-label={data?.title ? `Read news: ${data.title}` : 'Read news'}
          className="
