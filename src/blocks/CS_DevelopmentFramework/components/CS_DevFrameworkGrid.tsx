...
//   const hasNextDesktopItem = activeIndex < items.length - 1
...
//             <p className="mt-[8px] font-grift global-p5 text-secondary-2">
//               {block.lifecycle.subtitle}
//             </p>
//           )}
//         </div>

//         <div className="no-scrollbar mt-[24px] flex gap-[10px] overflow-x-auto pb-[4px]">
...
//                 <h3
//                   className="
//                     font-agency text-[34px] leading-[1.05]
//                     text-secondary-1
//                     md:text-[40px]
//                   "
//                 >
...
//                 <p className="mt-[14px] font-grift global-p4 leading-[1.6] text-secondary-2">
//                   {activeItem.mainContent.description}
//                 </p>
//               )}
//             </div>
...
//             className="
//               flex flex-col
//               lg:mt-[46px] lg:gap-[12px]
//               xl:mt-[52px] xl:gap-[14px]
//               2xl:mt-[58px] 2xl:gap-[16px]
//             "
//           >
//             {items.map((item, index) => {
//               const isActive = index === activeIndex
...
//             ${
//               hasNextDesktopItem
//                 ? 'lg:h-[650px] xl:h-[720px] 2xl:h-[780px]'
//                 : 'lg:h-[325px] xl:h-[360px] 2xl:h-[390px]'
//             }
//           `}
//         >
...
//                       size-[64px] -translate-x-1/2 -translate-y-1/2
