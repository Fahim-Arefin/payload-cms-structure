...
import {
  CAREER_CARDS_BLOCK_LABEL,
  CAREER_CARDS_BLOCK_THUMBNAIL_URL,
...
const CareerCardsSchema: Block = {
  slug: CAREER_CARDS_SLUG_AND_TAG,
  labels: {
    singular: CAREER_CARDS_BLOCK_LABEL,
    plural: CAREER_CARDS_BLOCK_LABEL,
  },

  imageURL: CAREER_CARDS_BLOCK_THUMBNAIL_URL,
  imageAltText: `${CAREER_CARDS_BLOCK_LABEL} preview`,
  ...
  fields: [
    {
      ...
      fields: [
        ...
        ...generateArrayImageFields({
          ...
          quality: 0.9,
          maxKB: 600,
          ownerCollection: CAREER_CARDS_SLUG_AND_TAG as any,
          required: true,
        } as any),
          ...
          fields: [
            {
              ...
              validate: validateShortText('Title', DESC_LINE_MAX, true),
              admin: {
                width: '50%',
            ...
            },
            {
              ...
              label: 'শিরোনাম (বাংলা)',
              maxLength: DESC_LINE_MAX,
              validate: validateShortText('Title (BN)', DESC_LINE_MAX, true),
              admin: {
                width: '50%',
                description: `একটি ছোট শিরোনাম। সর্বোচ্চ ${bnNum(DESC_LINE_MAX)} অক্ষর।`,
              },
            },
          ],
        },
          ...
          fields: [
            {
              ...
              label: 'Description',
              maxLength: DESC_LINE_MAX,
              validate: validateShortText('Description', DESC_LINE_MAX, true),
              admin: {
                width: '50%',
                description: `One short line. Max ${DESC_LINE_MAX} characters.`,
              },
            },
            {
              ...
              label: 'বিবরণ (বাংলা)',
              maxLength: DESC_LINE_MAX,
              validate: validateShortText('Description (BN)', DESC_LINE_MAX, true),
              admin: {
                width: '50%',
...
export default CareerCardsSchema
