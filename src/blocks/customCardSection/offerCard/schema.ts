...
import {
  OFFER_CARDS_BLOCK_LABEL,
  OFFER_CARDS_BLOCK_THUMBNAIL_URL,
...
const OfferCardsSchema: Block = {
  slug: OFFER_CARDS_SLUG_AND_TAG,
  labels: {
    singular: OFFER_CARDS_BLOCK_LABEL,
    plural: OFFER_CARDS_BLOCK_LABEL,
  },

  imageURL: OFFER_CARDS_BLOCK_THUMBNAIL_URL,
  imageAltText: `${OFFER_CARDS_BLOCK_LABEL} preview`,
  ...
  fields: [
    {
      ...
      fields: [
        ...
        ...generateArrayImageFields({
          ...
          quality: 0.9,
          maxKB: 600,
          ownerCollection: OFFER_CARDS_SLUG_AND_TAG as any,
        } as any),
...
export default OfferCardsSchema
