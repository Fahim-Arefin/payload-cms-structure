...
function ArticleCardCTA({ ctaButton, itemId, detailsPage = false, className }: Props) {
  ...
  return (
    <Link
      ...
      className={`
        ...
        outline-none
        ${isSecondary ? 'text-secondary-1' : 'text-primary-1'}
        ${className ?? ''}
      `}
    >
      ...
      <span className="relative z-10 flex items-center justify-center">
        <span
          ...
          className={`
            ...
            ${isSecondary ? 'bg-secondary-1' : 'bg-primary-1'}
          `}
        />
