          ...
          <div className={cn(`grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-0`)}>
            ...
            <Dialog>
              <DialogTrigger asChild>
                <div
                  className={cn(
                    `relative group cursor-pointer h-[200px] lg:h-[250px] xl:h-[300px] w-full bg-no-repeat bg-cover bg-center md:rounded-[5.333px_5.333px_53.333px_5.333px] lg:rounded-[8.333px_8.333px_53.333px_8.333px] overflow-hidden transition-all`,
                    'order-1',
                  )}
                  style={{
