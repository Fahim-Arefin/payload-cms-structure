...
function AllPlanIndividualCard({ data, blur }: Props) {
  return (
    ...
    h-[250px] md:h-[250px] xl:h-[300px] 2xl:h-[400px] 
    ...
    >
      ...
      >
        <div className="h-[50%] flex items-start">
          <h3 className="text-[14px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px] font-medium uppercase">
            {data?.title}
             ...
             {
              data?.biggerTitle &&
              <p className='text-[28px] lg:text-[28px] xl:text-[18px] 2xl:text-[28px] font-medium uppercase'>
                {data?.biggerTitle}
              </p>
             }
          </h3>
        ...
        h-[60%] w-[80%] flex flex-col justify-between`}
        >
