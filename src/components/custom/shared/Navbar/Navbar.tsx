...
//     { href: '/purchase', label: 'Purchase Now' },
//   ]
...
//         `font-avenir
//         h-[60px] md:h-[80px] 2xl:h-[105px]
//         lg:w-[95%] 2xl:w-[90%] mx-auto
//         rounded-[82px]
//         px-4 lg:px-[72px]
...
// V1 NEW NAVBAR WITHOUT MOBILE DESIGN
...
//   return (
//     <nav
//       className="font-avenir absolute top-24 z-50 inset-x-0 container-width
//       px-4 py-2 md:px-8 md:py-3
//       lg:h-[60px] xl:h-[70px] 2xl:h-[80px]
...
//     >
//       {/* Logo */}
//       <div className="flex items-center space-x-1 lg:w-[60px] lg:h[60px] xl:w-fit xl:h-fit">
//         <img src="/assets/mainlogo.png" alt="logo" className="h-full w-full" />
//       </div>
...
//        lg:text-[14px] xl:text-lg text-[#1E1E1E] items-center lg:leading-6 xl:leading-8"
//       >
...
//       {/* Right - Icons */}
//       <div className="flex items-center space-x-2 xl:space-x-8 text-[#1F1F1F]">
//         <svg
//           xmlns="http://www.w3.org/2000/svg"
//           width="24"
//           height="24"
...
//     <>
//       <nav
//         className="font-avenir absolute top-0 lg:top-24 z-50 inset-x-0 container-width
//         px-4 py-2 md:px-8 md:py-3
...
//           <div className="flex items-center space-x-1 w-[60px] xl:w-fit">
...
//         {/* Desktop Right Icons */}
//         <div className="hidden lg:flex items-center space-x-2 xl:space-x-8 text-[#1F1F1F]">
//           <svg
//             xmlns="http://www.w3.org/2000/svg"
//             width="24"
//             height="24"
