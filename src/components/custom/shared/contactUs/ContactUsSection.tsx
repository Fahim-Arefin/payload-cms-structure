  ...
  const sendMessageHandler = async (e: React.FormEvent) => {
    ...
    await fetch('/api/emails/ask-us', {
      ...
      body: JSON.stringify({
        ...
        phone,
        message,
        recipients, // you already added this earlier
        senderOverride: {
          fromName: data?.senderOverride?.fromName || null,
          fromEmail: data?.senderOverride?.fromEmail || null,
        },
      }),
    })
      .then((rs) => rs.json())
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <Textarea
                ...
                rows={3}
              />
              {messageError && <p className="text-red-500 text-xs pl-1">{messageError}</p>}
            </div>
