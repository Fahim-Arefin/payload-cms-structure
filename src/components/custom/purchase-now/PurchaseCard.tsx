...
import { PurchaseCardDataType } from '@/types'
...
const PurchaseCard: FC<PurchaseCardProps> = ({ data, blur }: PurchaseCardProps) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <PurchaseCardModal open={open} onOpenChange={setOpen} />
        </>
  )
}
