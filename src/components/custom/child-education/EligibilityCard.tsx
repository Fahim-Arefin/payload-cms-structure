...
export const EligibilityCard: React.FC<EligibilityCardProps> = ({
  ...
  return (
    <div
      className="rounded-xl p-4 lg:p-12 overflow-hidden shadow-lg bg-cover bg-center flex flex-col"
      style={{
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center space-y-6 mt-6">
        ...
        >
          ...
          <div className="flex justify-between w-full px-2 text-white">
            <div className="flex flex-col items-center">
              <span className="text-xs mb-1 font-light text-[#FCF4EB]">Minimum</span>
              <span className="global-span font-bold">{entryMin}</span>
              <span className="text-base font-light">{entryMinLabel}</span>
            </div>

            <div className="flex flex-col items-center">
              <span className="text-xs mb-1 font-light">Maximum</span>
              <span className="global-span font-bold">{entryMax}</span>
              <span className="text-base font-light">{entryMaxLabel}</span>
            </div>
          </div>
        </div>
        {/* Policy Term */}
        ...
        >
          <div className="text-white global-p2 uppercase mb-1 font-light tracking-widest">
            Policy Term
          </div>
