...
function SearchBarSection() {
  return (
    <div className="z-40 flex justify-center items-center px-14 py-12 sm:p-8 md:p-16 lg:p-24 bg-white">
      <div
        className="w-full max-w-md sm:max-w-lg lg:max-w-xl bg-[#F6EDDD] rounded-md p-1 relative"
