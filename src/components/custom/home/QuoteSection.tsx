        ...
        <div className="p-4 lg:pl-0 space-y-8 xl:space-y-11 z-10">
          ...
          <div className="hidden md:grid grid-cols-3 bg-[#FFFFFFCC] rounded-b-lg border-t-2 border-[#FF6600]">
            <div className="col-span-1 border-r-2 border-[#D9D9D9] p-2 py-6 xl:py-9 lg:mt-6 xl:mt-12 ">
              ...
              <div className="text-[#1E1E1E] lg:text-xl xl:text-3xl font-bold text-center">
                10,000.00
              </div>
            </div>
            <div className="col-span-1 border-r-2 border-[#D9D9D9] p-2 py-6 xl:py-9 lg:mt-6 xl:mt-12">
              ...
              <div className="text-[#ED7125] text-xl xl:text-3xl font-bold text-center">
                20,000.00
              </div>
            </div>
            <div className="col-span-1 p-2 py-6 xl:py-9 lg:mt-6 xl:mt-12 ">
              ...
              <div className="text-[#1E1E1E] text-xl xl:text-3xl font-bold text-center">
                1,00,000.00
              </div>
            </div>
            <div className="col-span-3 py-7 px-10 xl:py-9 xl:px-12 space-y-3">
              <div className="bg-[#F6EDDD] md:px-4 lg:px-1 md:py-1.5 lg:py-1 xl:px-4 xl:py-1.5 md:w-[60%] lg:w-[100%] xl:w-[70%] mx-auto rounded-full flex items-center space-x-2">
                <div>
                  <svg
                    width="24"
                    height="24"
