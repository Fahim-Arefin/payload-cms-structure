...
insurance: [
  ...
  },
  {
    value: 'item-2',
    title:
      'I work for a  company which is operating in Bangladesh. Can I take a group policy ?',
    titleBN:
      'আমি কি বাংলাদেশে কার্যরত একটি কোম্পানিতে কাজ করার কারণে গ্রুপ পলিসি নিতে পারি?',
    content: [
    ...
    >
      <div className="text-[#434343] space-y-8 lg:space-y-12">
        ...
        <Accordion type="single" collapsible className="w-full" defaultValue="item-1">
          {accordionItems.map(({ value, title, titleBN, content, contentBN }, index) => {
