...
const SupportOVCSection: FC<SupportOVCSectionProps> = ({}) => {
  ...
  return (
    <div className="pt-[150px] md:pt-[100px] lg:pt-[150px] xl:pt-[200px] pb-8 md:pb-12 lg:pb-[75px] xl:pb-[90px] 2xl:pb-[100px] bg-white">
      <div className="relative w-full font-avenir h-[230px] md:h-[350px] lg:h-[400px] xl:h-[550px] 2xl:h-[600px]">
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `linear-gradient(0deg, rgba(0,0,0,0.2), rgba(0,0,0,0.2)), url('/assets/thumbnails/yt-thumbnail-10.jpg')`,
