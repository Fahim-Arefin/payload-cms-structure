...
//       {/* top */}
//       <div
//         className="border border-black h-[50%] flex flex-row justify-end items-center gap-6  bg-red-700
...
//       <div
//         className="h-[50%]
//         flex items-center justify-end bg-red-600"
//       >
//         {/* main links */}
//         <div
...
//             <div
//               className="border border-black flex items-center justify-between
...
//                   bg-transparent hover:bg-border-2 text-dark-3 hover:text-white-1
//                   border border-dark-3 w-full"
//                 >
//                   Contact Us
//                 </Button>
//               </div>
...
//   ${isActive ? '-translate-y-[3px] text-border-2' : 'hover:-translate-y-[3px]'}
...
//           <React.Fragment key={index}>
//             <div className="">
//               <Link href={item?.href} className={navLinkClass(isItemActive(item?.href))}>
//                 <div>
//                   <LocalizedText en={item?.label} bn={item?.label} />
//                 </div>
//               </Link>
