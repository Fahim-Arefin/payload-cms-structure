...
// type Props = {
//   className?: string
//   data: NonNullable<NonNullable<ProductAdvantageCardBlockType['testLabCards']>[number]>
// }

// function TestLabCard({ className, data }: Props) {
//   return (
//     <div
...
//         <div
//           className={`relative rounded-full transition-all duration-300 ease-in
...
//           <div
//             className={`font-proxima global-h4 font-bold text-dark-1 transition-all duration-300 ease-in group-hover/testCard:text-white`}
//           >
