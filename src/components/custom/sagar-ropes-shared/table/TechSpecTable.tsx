...
//       {/* heading */}
//       <div
//         className="grid grid-cols-12 font-grift global-h3 font-bold border-b-2 border-[#0C1E21]
//        gap-12
...
//             key={index}
//           >
//             <div className="col-span-4 md:col-span-3 font-grift global-h4 font-bold ">
//               {item?.name}
//             </div>
//             <div
...
function TechSpecTable({ className, data, specNameHeader, detailsHeader }: Props) {
  return (
    <div className={` ${className}`}>
      {/* heading */}
      <div
        className="flex flex-row justify-between font-grift global-h3 font-bold border-b-2 border-[#0C1E21]
      ...
      <div className="">
       ...
       "
          ...
          >
            ...
            font-grift global-h4 font-bold "
            >
              {item?.name}
            </div>
            <div
