...
ব্যাংক লিমিটেড-এর স্পন্সর ডিরেক্টর ও সাবেক চেয়ারম্যান এবং শান্তা হোল্ডিংস লিমিটেড ও শান্তা সিকিউরিটিজ লিমিটেড-এর ব্যবস্থাপনা পরিচালক হিসেবে দায়িত্ব পালন করছেন।`,
  ...
  },
  {
    ...
    descriptionBN: `ঢাকা ব্যাংকের সাবেক চেয়ারপারসন এবং জনাব খন্দকার মনির উদ্দিন এর সহধর্মিনী মিসেস জেসমিন সুলতানা, 
    শান্তা হোল্ডিংস এর সাফল্যে অন্যতম অংশীদার। তিনি দীর্ঘ অভিজ্ঞতাসম্পন্ন একজন প্রতিষ্ঠিত উদ্যোক্তা এবং বাংলাদেশ সরকার কর্তৃক স্বীকৃত
     সিআইপি (Commercially Important Person)। তার দৃঢ় নেতৃত্ব ও  পরিচালনায়, শান্তা হোল্ডিংস বর্তমানে বাংলাদেশের শীর্ষস্থানীয় রিয়েল 
     এস্টেট ডেভলপার হিসেবে প্রতিষ্ঠিত। 
...
export const leaders: Leaders[] = [
  {
    ...
    করপোরেট সেলস, মার্কেট সম্প্রসারণ ও কৌশলগত পরিকল্পনায় অসামান্য দক্ষতা অর্জন করেছেন। তিনি অ্যাক্সিওম 
    টেকনোলজিস লিমিটেড-এর নেটওয়ার্ক (ডিস্ট্রিবিউশন) প্রধান এবং ইন্টেগ্রা কমিউনিকেশন্স লিমিটেড-এর সেলস অ্যান্ড 
    মার্কেটিং ম্যানেজার হিসেবে দায়িত্ব পালন করেছেন। 
    ২০০১ সালে তিনি মেটলাইফ বাংলাদেশে যোগ দেন এবং নিষ্ঠা ও কর্মদক্ষতার স্বীকৃতিস্বরূপ  ডেপুটি এজেন্সি ডিরেক্টর (২০০৬)
    এবং এজেন্সি ডিরেক্টর (২০১৩) পদে উন্নীত হন। এই সময়ে তিনি ক্যারিয়ার এজেন্সি চ্যানেলের সম্প্রসারণ ও প্রফিট বৃদ্ধিতে
